...
// */
//@Component
//public class CustomerToDogRepository extends RelationshipRepositoryBase<Customer, Long, Dog, Long> {
//    protected CustomerToDogRepository(Class<Customer> sourceResourceClass, Class<Dog> targetResourceClass) {
